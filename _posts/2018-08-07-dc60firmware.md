...
* .hex file can be generated either using a QMK compiler, or an online tool. In this guide, we will be demonstrating with the QMK firmware builder provided by Ruiqi Mao. And the website is: [http://qmkeyboard.cn/](http://qmkeyboard.cn/)。
