...
{% capture images %}
    ...
    https://raw.githubusercontent.com/yilihong/alf/gh-pages/assets/img/doro67/gb/8.jpg
{% endcapture %}
{% include gallery images=images caption="color options (titanium grey not shown)" cols=3 %}
